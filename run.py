...
def train(config):
    ...
    for epoch in range(1):
        ...
        for data in build_train_iterator(batch_size=24):
            ...
            logit1, logit2, predict_type, predict_support = model(is_support, context_idxs, ques_idxs, context_char_idxs, ques_char_idxs, context_lens, start_mapping, end_mapping, all_mapping, return_yp=False)
